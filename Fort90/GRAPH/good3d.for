...
c			: number by PRJSCA
	...
	allocatable::azR,axR,ayR,gax,gay
...
1801	   FORMAT(I5,I5,5F10.5)
	   j=1
1802	   i=1
1803     write(unit=12,fmt=1801) j,i,(z(j,k),k=i,i+4)
	   i=i+5
	   if(i.le.nbiny) goto 1803
	   j=j+1
	   if(j.le.nbinx) goto 1802
...
805	format(2I5)
	write(unit=12,fmt=805) nbinxr,nbinyr
      j=1
8021	i=1
8071	write(unit=12,fmt=801) j,i,(res(j,k),k=i,i+4)
      i=i+5
      if(i.le.nbinyr) goto 8071
      j=j+1
