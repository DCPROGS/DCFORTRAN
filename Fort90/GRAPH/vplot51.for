...
c---For scale factors (see SCALCURV)
	...
	logical xdone,ydone,meta,wmeta,wbmp,nojump
c///
c for interpolation
	...
	character*33 metafil,printfil,oldfile,printer
	character*40 qfile
...
c	rlt=0.2	      !default thickness, unless reset
...
c        Put do 215 loop + interp drawing into DRAWDAT, to draw curve # j
     ...
     &       ndat(j),ijoin(j),icol(j0),isym(j),syms(j),RLTH(j0),
...
c     CALC CURVE (before rescale options)
	...
	if(idev.ge.7.and.ncurvc.le.0.and.PLOT) goto 1813	!do vtrans
15	continue
...
c =========================================================================
	...
	if(idev.ge.7.and.PLOT) goto 1813	!do vtrans
