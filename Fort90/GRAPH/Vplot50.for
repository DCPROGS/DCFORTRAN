...
c for interpolation
	...
	character*33 metafil,printfil,oldfile,printer,filnam
	character*40 qfile
...
c	    idraw(6)=-1	!so drawn with box by default
...
c		icw=icurvw(j1)	!SD control for curve 1,2,....
