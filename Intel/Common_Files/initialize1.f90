...
! Create toggle button initwin_Toggle12 child of initwin_Radio3
   initwin_Toggle12 = gmCreateToggleButton(initwin_Radio3, 20, 5, 200, 25, 'Append print to existing file', 0, gmType=G3DRADIO, gmVpos=GTOP)

! Create toggle button initwin_Toggle13 child of initwin_Radio3
   initwin_Toggle13 = gmCreateToggleButton(initwin_Radio3, 20, 35, 200, 25, 'Start new printout file', 0, gmType=G3DRADIO, gmVpos=GTOP)
...
! Create toggle button initwin_Toggle4 child of initwin_Radio1
   initwin_Toggle4 = gmCreateToggleButton(initwin_Radio1, 40, 50, 220, 25, 'Show data and HJC distributions', 0, gmType=G3DRADIO, &
