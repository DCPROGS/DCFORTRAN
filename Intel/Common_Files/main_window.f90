...
iheight=32
	...
	titleprogram='Ekdist'
	else if(program_type.eq.5) then
	titleprogram='Siman'
	endif
...
separator1_3 = gmCreateMenuSeparator(MainPop1_1)
  modelw(3) = gmCreateMenuEntry(MainPop1_1, 'Start again', gmAccel=84,gmCallBack=-10)
...
ENDIF
   ...
   IF(PROGRAM_TYPE.EQ.1.or.program_type.eq.4) THEN
...
IF(PROGRAM_TYPE.ge.2.and.PROGRAM_TYPE.le.4) THEN
...
! Create pull-down menu MainPop6 child of Help
 ...
 ! iHowto=gmCreateMenuEntry(MainPop1_13, 'How to .....', gmAccel=65)
  ! !MainPop1_17 = gmCreatePullDownMenu(ihowto)
   istart = gmCreateMenuEntry(MainPop1_13, 'Modify mechanism', gmAccel=90, gmCallBack=971) !610)
