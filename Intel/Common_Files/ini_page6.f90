...
readini,initmec,nlig,initialpage,ini_MainPanel,ini_panel1,ini_panel1_1,ini_Text1_1,ini_Value2_1,ini_TxtArray2,&
	...
	ini_Value6_10,ini_Toggle8,nfast,ini_Value4_5,ini_TxtArray4_5,ini_Toggle1_3)
...
!   ini_Button1_2 = gmCreatePushButton(ini_Panel1, 30, 40, 60, 25, 'Edit', gmType=GUSERDEFINED, gmOffcol=228, gmTextCol=0, &
 !     gmVpos=GTOP,gmCallback=-112)
! ini_Text2 = gmCreateTextEntry(ini_Panel1, 380, 180, 65, 18,'DC model:', 255, gdisplay, gmBack1Col=0, gmBack2Col=12, &
!      gmTextCol=1 ,gmScrollMode=GVERTICAL, gmVpos=GTOP)
 !     ini_Toggle1_3 = gmCreateToggleButton(ini_Panel1, 400, 210, 20, 25, '', 0, gmType=G3DCHECKBOX, &
 !  gmVpos=GTOP,gmstatus=gunselectable)
!ini_Button1_3 = gmCreatePushButton(ini_Panel1, 380, 250, 60, 25, 'Edit', gmType=GUSERDEFINED, gmOffcol=228, gmTextCol=0, &
 !    gmVpos=GTOP,gmCallback=-113)
...
! Create panel ini_Panel2 child of ini_MainPanel
 ...
 ini_Text2 = gmCreateTextEntry(ini_Panel2, 20, 2, 165, 20,'# set by microscopic', 255, gdisplay, gmBack1Col=0, &
      gmBack2Col=12, gmTextCol=1 , gmVpos=GTOP,gmhpos=Gleft)
ini_Text2 = gmCreateTextEntry(ini_Panel2, 20, 22, 120, 20,'reversibility =', 255, gdisplay, gmBack1Col=0, &
      gmBack2Col=12, gmTextCol=1 , gmVpos=GTOP,gmhpos=Gleft)
   ini_Button2_2 = gmCreatePushButton(ini_Panel2, 165, 10, 50, 25, 'Edit', gmType=GUSERDEFINED, gmOffcol=228, gmTextCol=0, &
      gmVpos=GTOP,gmhpos=Gleft,gmCallback=-122)

   ini_Value2_1 = gmCreateValueEntry(ini_Panel2, 110, 22, 40, 20, 0.000000, 8, 0, gdisplay,  &
...
nrowp=10
   ...
   ini_TxtArray2 = gmCreateTextArray(ini_Panel2, 10, 45, 220, 90, ncolp, nrowp, gmAxisW=40, gmAxisH=25, gmXtext=xtext, &
...
! Create panel ini_Panel3 child of ini_MainPanel
   ini_Panel3 = gmCreatePanel(ini_MainPanel, 0, 450, 460, 280, gmType=GINVERSECHISEL, gmLineBorder=GOUTEREDGE, &
...
xtext='Q(i,j) '//char(124)//'Name'//char(124)//'Factor'//char(124)//'Q(i,j) '//char(124)//'Name'
   ini_TxtArray3 = gmCreateTextArray(ini_Panel3, 10, 40, 440, 100, 5, 20, gmAxisW=40, gmAxisH=25, gmXtext=xtext, &
...
! Create panel ini_Panel4 child of ini_MainPanel
 !  ini_Panel4 = gmCreatePanel(ini_MainPanel, 0, 590, 460, 140, gmType=GINVERSECHISEL, gmLineBorder=GOUTEREDGE, &
  !    gmFillcol=icolm, gmFillBorder=GOUTEREDGE, gmScrollMode=GNOBARS, gmVpos=GTOP)
   ...
   ini_Text4_1 = gmCreateTextEntry(ini_Panel3, 20, 150, 100, 25,'# of fixed rates=', 255, gdisplay, gmBack1Col=0, gmBack2Col=12, &
      gmTextCol=1 ,gmScrollMode=GVERTICAL, gmVpos=GTOP)

   ini_Value4_1 = gmCreateValueEntry(ini_Panel3, 120, 150, 40, 25, 0.000000, 8, 0, gdisplay,&
      gmType=GDECIMAL, gmBack1Col=0, gmBack2Col=0, gmTextCol=0, gmVpos=GTOP)

xtext='Q(i,j) '//char(124)//'Name '
   ini_TxtArray4_1 = gmCreateTextArray(ini_Panel3, 10, 180, 220, 90, 2, 20, gmAxisW=40, gmAxisH=25, gmXtext=xtext, &
      gmYtext='*digits', gmXjust=GCENTRE, gmYjust=GCENTRE, gmScrollMode=GBOTHBARS, gmVpos=GTOP)
   ...
   enddo
    ...
    ini_Text4_5 = gmCreateTextEntry(ini_Panel3, 235, 150, 100, 25,'# fast blocks=', 255, gdisplay, gmBack1Col=0, gmBack2Col=12, &
      gmTextCol=1 ,gmScrollMode=GVERTICAL, gmVpos=GTOP)

   ini_Value4_5 = gmCreateValueEntry(ini_Panel3, 350, 150, 40, 25, 0.000000, 8, 0, gdisplay,&
      gmType=GDECIMAL, gmBack1Col=0, gmBack2Col=0, gmTextCol=0, gmVpos=GTOP)
call gmsetvaluesetting(ini_Value4_5,nfast)
xtext='Q(i,j) '//char(124)//'Name '
   ini_TxtArray4_5 = gmCreateTextArray(ini_Panel3, 235, 180, 220, 90, 2, 20, gmAxisW=40, gmAxisH=25, gmXtext=xtext, &
      gmYtext='*digits', gmXjust=GCENTRE, gmYjust=GCENTRE, gmScrollMode=GBOTHBARS, gmVpos=GTOP)
   call gmEnqCellAttribs(ini_TxtArray4_5, 1, 1, arrayattribs)
   ...
   do j=1,20
   call gmSetCellAttribs(ini_TxtArray4_5, 1, j, arrayattribs)
   enddo
   ...
   do j=1,20
   call gmSetCellAttribs(ini_TxtArray4_5, 2, j, arrayattribs)
   enddo
! Create button ini_Button8 child of ini_Panel4
 !  ini_Button4_12 = gmCreatePushButton(ini_Panel3, 160, 150, 55, 25, 'Edit', gmType=GUSERDEFINED, gmOffcol=228, gmTextCol=0, &
  !   gmVpos=GTOP,gmCallback=-142) !edit fix rates !!!!
! Create text widget ini_Text5 child of ini_Panel4

   ini_Text4_2 = gmCreateTextEntry(ini_Panel2, 235, 10, 140, 25,'# constrained by EC50=', 255, gdisplay, gmBack1Col=0, &
      gmBack2Col=12, gmTextCol=1 ,gmScrollMode=GVERTICAL, gmVpos=GTOP)
! Create value entry ini_Value4 child of ini_Panel4
   ini_Value4_2 = gmCreateValueEntry(ini_Panel2, 375, 10, 25, 25, 0.000000, 8, 0, gdisplay,  &
      gmType=GDECIMAL, gmBack1Col=0, gmBack2Col=0, gmTextCol=0, gmVpos=GTOP)
	call gmsetvaluesetting(ini_Value4_1,nfix)
	xtext='Q(i,j) '//char(124)//'Name '
   ini_TxtArray4_2 = gmCreateTextArray(ini_Panel2, 235, 45, 220, 90, 2, 20, gmAxisW=40, gmAxisH=25, gmXtext=xtext, &
      gmYtext='*digits', gmXjust=GCENTRE, gmYjust=GCENTRE, gmScrollMode=GBOTHBARS, gmVpos=GTOP)
   ...
   ini_Button4_22 = gmCreatePushButton(ini_Panel2, 400, 10, 50, 25, 'Edit', gmType=GUSERDEFINED, gmOffcol=228, gmTextCol=0, &
