...
c		   ncyc=ncyc+1
c		   if(ncyc.eq.n0) goto 90	!n0=array size
c		   do j1=1,mc
c		      icycsav(ncyc,j1)=icyc(j1)
c		   enddo
c		   nsc(ncyc)=mc-1
cc		   print 318,(icyc(i2),i2=1,mc)
cc318		   format(' Cycle found: ICYC=',20i3)
cc 		   pause
c		   goto 44			!return to last node
c		endif
