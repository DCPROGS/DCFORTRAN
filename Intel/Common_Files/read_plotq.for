	subroutine Read_plotq(istrec,xval,yval,xcal,ycal,ndimd,ndimc,ncurvd,
	...
	LOGICAL doframe,mono,mono1,interp
	logical discprt
...
c extra args to hold all details of posh plots
	...
	real csfac(30),sizet(30),angle(100),sizetext(100)
...
c integer*2 copies to save disc space
	...
	integer*4 itype(250),jcols(250),jdraw(250)
...
c
     ...
     &  ncjump,t1c,t2c,nvjump,t1v,t2v,xoff1,y1v,y2v,y1c,y2c,ivplot,
     &  mono1,interp,nhline,nvline,ntrace,ytsep,ioffset,jmiss
         else
	    read(11,rec=istrec) iptype,ndv2,ndimd2,ndc2,ndimc2,
...
c NB ndat() could be bigger than 32k, so kept as integer*4
	k=0
      if(iver.eq.1100.or.iver.eq.1200) goto 101		!index for int2cop
