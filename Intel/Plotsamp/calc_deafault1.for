...
!	xmin1=xmin		!save input values
!	xmax1=xmax		!save input values
!	ymin1=ymin		!save input values
!	ymax1=ymax
!	xmin2=xmin		!save input values
!	xmax2=xmax		!save input values
!	ymin2=ymin		!save input values
!	ymax2=ymax
	endif
221	continue
	if(ymin1.ge.ycross) then 
		ymin1=ycross
	    ymin1=ycross-0.1*(ymax1-ymin1)
	endif
	if(autplt) goto 2
